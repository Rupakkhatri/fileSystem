...
LIBS =pthread
DEPS = 
ADDOBJ= fsLow.o b_io.o freeBit.o mfs.o fsLowDriver.o
...
formatVolume: formatVolume.o $(ADDOBJ)
	$(CC) -o $@ $^ $(CFLAGS) -l $(LIBS)
...
clean:
	rm *.o fsshell fileExplorer formatVolume
...
format:
	make formatVolume
	./formatVolume $(VOLUMENAME) $(VOLUMESIZE) $(BLOCKSIZE)
